...
namespace ZionBuilderPro\Elements\WooUpsells;
 ...
 */
class WooUpsells extends WooCommerceElement {
	/**
	 * Get type
	 *
	...
	public function get_name() {
		return __( 'Woo product upsells', 'zionbuilder-pro' );
	}
