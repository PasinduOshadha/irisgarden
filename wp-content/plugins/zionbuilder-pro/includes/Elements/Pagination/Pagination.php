...
class Pagination extends Element {
	...
	public function enqueue_styles() {
		...
		$this->enqueue_element_style( Utils::get_file_url( 'dist/css/elements/Pagination/frontend.css' ) );
	}
	...
	public function render( $options ) {
		...
		if ( $show_numbers ) {
			...
			echo \get_next_posts_link( $previous_text, $query->max_num_pages );
			echo \get_previous_posts_link( $next_text );
		}
