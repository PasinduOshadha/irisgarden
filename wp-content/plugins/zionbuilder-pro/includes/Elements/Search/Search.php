...
class Search extends Element {
	...
	public function enqueue_styles() {
		...
		$this->enqueue_element_style( Utils::get_file_url( 'dist/css/elements/Search/frontend.css' ) );
	}
	...
	public function enqueue_scripts() {
		// Using helper methods will go through caching policy
		$this->enqueue_editor_script( Utils::get_file_url( 'dist/js/elements/Search/editor.js' ) );
	}
	/**
	 * Render
	 *
