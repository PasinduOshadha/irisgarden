...
class Editor {
	public function __construct() {
		...
		add_action( 'zionbuilder/rest/bulk_actions/after_action', [ $this, 'reset_repeater_data' ] );
	...
	public function reset_repeater_data( $action_config ) {
		if ( isset( $action_config['dynamic_data_source'] ) ) {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script(
			'zb-editor-pro',
			Utils::get_file_url( 'dist/js/editor.js' ),
			[
				'zb-editor',
			],
			Plugin::instance()->get_version(),
