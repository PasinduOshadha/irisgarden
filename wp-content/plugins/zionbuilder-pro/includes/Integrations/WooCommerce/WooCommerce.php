...
class WooCommerce implements IBaseIntegration {
	...
	public function register_elements( $elements_manager ) {
		$elements = [
			...
			'WooCartTotals\WooCartTotals',
			'WooCartProducts\WooCartProducts',
			'WooCrossSells\WooCrossSells',
			// 'WooCheckoutInfo\WooCheckoutInfo',
			// 'WooBilling\WooBilling',
			// 'WooCheckoutPayment\WooCheckoutPayment',
		];
