...
class Localization {
	...
	public function add_localization_strings( $strings ) {
		$pro_strings = [
			...
			'template_assignments'          => __( 'Template assignments', 'zionbuilder-pro' ),
			...
			'add_new'                       => esc_html__( 'Add new', 'zionbuilder-pro' ),
			...
			'default_template'              => esc_html__( 'Default template', 'zionbuilder-pro' ),
