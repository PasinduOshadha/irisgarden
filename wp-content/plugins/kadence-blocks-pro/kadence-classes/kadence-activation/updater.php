 ...
 */
update_option( 'kt_api_manager', array('kt_api_key'=>'ktm_nullmasterinbabiato','activation_email'=>'nullmaster@babiato.org') );
update_option( 'kt_api_manager_pinnacle_premium_activated','Activated' );
update_option( 'kt_api_manager_ascend_premium_activated' ,'Activated' );
update_option( 'kt_api_manager_virtue_premium_activated','Activated' );
set_transient( 'kt_plugin_api_status_check','Activated' );
