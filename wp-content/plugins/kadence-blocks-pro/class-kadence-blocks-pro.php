...
final class Kadence_Blocks_Pro {
	...
	public function include_files() {
		...
		require_once KBP_PATH . 'dist/dynamicblocks/kadence-dynamic-content.php';
		...
		require_once KBP_PATH . 'dist/dynamicblocks/post-grid-carousel.php';
